from residual_optimization.envs.sine_collision_variable_stiffness_env import SineCollisionVariableStiffnessEnv
...
# Environment
env = SineCollisionVariableStiffnessEnv(
    ...
    K_e_1=K_e_1,
    K_e_2=K_e_2,
    K_e_toggle_time=K_e_toggle_time
)
